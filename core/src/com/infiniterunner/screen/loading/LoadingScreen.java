package com.infiniterunner.screen.loading;
...
import com.infiniterunner.screen.game.GameStartScreen;
...
public class LoadingScreen extends ScreenAdapter {
    ...
    // == attributes ==
    private final InfiniteRunner game;
    ...
    // == constructors ==
    public LoadingScreen(InfiniteRunner game) {
        this.game = game;
    ...
    public void show() {
        ...
        assetManager.load(AssetDescriptors.SPRITE);
    }
